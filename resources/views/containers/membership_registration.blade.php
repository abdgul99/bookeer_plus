...
@section('content')
<img class="w-full absolute top-0 -z-10 max-h-[800px]" src="{{asset('assets/search_bg.png')}}" alt="">
    ...
    <div class="max-w-3xl mx-auto w-full">
        ...
        <form action="" class="my-5 space-y-5">
            <div class="border-b-2 border-gray-300 lg:flex space-y-2 lg:space-y-0  ">
                <div class="flex items-center gap-6 lg:justify-center font-semibold w-[250px] gap-5"><label for="">ログイン
