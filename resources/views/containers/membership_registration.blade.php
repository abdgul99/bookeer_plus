...
@section('content')
    ...
    <div class="lg:h-[80vh] grid items-center max-w-5xl mx-auto px-8">
        <div class="max-w-3xl mx-auto w-full">
            ...
            <button class="w-full p-3  text-white bg-[#F58220] hover:bg-[#ff8e2b]">ログイン情報を入力してください。</button>
            ...
            <form action="" class="my-5 space-y-5">
                ...
                <div class="grid justify-center">
                    <button class="p-3 bg-[#F58220] rounded px-5 text-white hover:bg-[#ff8e2b]">ログイン</button>
                </div>
            </form>
        </div>
    </div>
