...
@section('content')
    <img class="w-full absolute top-10 lg:top-0 -z-10" src="{{ asset('assets/hero_bg.png') }}" alt="">
    <div class="lg:px-4 lg:p-0">
        <div
            class="max-w-5xl  mx-auto text-2xl font-semibold mt-20 lg:mt-40 bg-white lg:bg-gray-100 border relative p-6 lg:p-0 mb-40 ">
            <div class="max-w-sm grid items-center mx-auto text-center">
                <h2 class="border-b-2 border-white lg:border-black "><span>BOOKER </span><span
                                ...
                                <ul class=" text-[10px] lg:text-12 mt-2">
                                                        ...
                                                        <div class="p-4 md:p-5 space-y-4">
                                                            <form action="{{ route('profile.updateGender') }}"
                                                                ...
                                                                <div class="flex items">
                                                                    <button type="submit"
                                                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update</button>
                                                                    <button data-modal-hide="gender-modal" type="button"
                                                                        class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Cancel</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                    ...
                                    <li class="grid grid-cols-3 border-b-2 border-black p-1 items-center"><span>Blog</span>
                                        <span>{{ $user->website ?? '' }}</span> <span class="flex justify-end">
                                            ...
                                            <!-- Modal toggle -->
                                            <button data-modal-target="website-modal" data-modal-toggle="website-modal"
                                                class=" lg:w-[120px] text-[10px] bg-[#D9D9D9] px-5 " type="button">
                                                edit
                                            </button>
                                                        ...
                                                        <div class="p-4 md:p-5 space-y-4">
                                                            <form action="{{ route('profile.updateWebsite') }}"
                                                                ...
                                                                <div class="flex items">
                                                                    <button type="submit"
                                                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update</button>
                                                                    <button data-modal-hide="website-modal" type="button"
                                                                        class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Cancel</button>
                                                                </div>
                                                            </form>
                                                        </div>
