...
@section('content')
    <img class="w-full absolute top-10 lg:top-0 -z-10 brightness-75" src="{{ asset('assets/company.png') }}" alt="">
    <div class="lg:min-h-[170vh]">
            ...
            <div>
                <ul class="text-[15px] p-7">
                    <li class="flex items-center p-1 px-2 border-b-2 border-black "><span
                            class="w-[200px] text-[F58220]">Company
                            Name</span><span>Uni-8
                            Corporation</span>
                    </li>
                    <li class="flex items-center p-1 px-2 border-b-2 border-black "><span
                            class="w-[200px] text-[F58220]">Board
                            of
                    ...
                    <li class="flex items-center p-1 px-2 border-b-2 border-black "><span
                            class="w-[200px] text-[F58220]">Location</span><span>Nihonbashi Mizuno Bldg. 7F, 1-11-12
                            Nihonbashi
