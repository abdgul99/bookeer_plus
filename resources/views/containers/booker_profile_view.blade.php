...
@section('content')
    ...
    <div class="max-w-5xl  mx-auto text-2xl font-semibold mt-20 lg:mt-40 lg:bg-gray-100 border relative p-6 lg:p-0 mb-40 ">
        ...
        <div class="w-full lg:flex">
            <a href="" class="p-3 px-5 float-left mt-12 text-[18px] text-white flex items-center justify-between border-b-2 w-full bg-[#F5821F] lg:w-[482px] border-b-[F5821F] translate-x-8">Send Message</a>
            <a href="{{ route('favorite_unfavorite_booker', ['id' => request()->route()->parameters['id']]) }}"
                class="p-3 px-5 float-right mt-12 text-[18px] text-dark flex items-center justify-between border-b-2 w-full bg-[#FFFFFF] lg:w-[482px] border-b-[F5821F] translate-x-8">
