...
.imgBg{
    ...
    <div class="bg-white">
        {{-- <img class="w-full absolute top-0 -z-10 max-h-[1100px] hidden lg:block" src="{{ asset('assets/search_bg.png') }}"
            alt=""> --}}
            <div class="imgBg"></div>
        <div class="lg:h-[100vh] grid items-center max-w-5xl mt-16  mx-auto lg:mb-[400px] px-8 relative">
                ...
                @if ($errors->any())
                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                        ...
                        <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                            <svg onclick="this.parentElement.remove()" class="fill-current h-6 w-6 text-red-500"
                ...
                <form action="{{ route('register') }}" method="POST" class="my-5 space-y-5">
                    ...
                    <div class="border-b-2 border-gray-300 lg:flex space-y-2">
                        <div class="flex items-center gap-2 font-semibold w-[250px] lg:justify-between px-2">
                            <label for="" class="text-[13px] lg:text-base"
                                class="text-[13px] lg:text-base">お名前</label>
